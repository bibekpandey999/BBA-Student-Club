...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="py-20 bg-background px-4 sm:px-6 lg:px-8">
            ...
            {displayImages.map((image) => {
              ...
              return (
                <div
                  ...
                  className="relative h-64 bg-gradient-to-br from-primary to-emerald-700 rounded-lg overflow-hidden cursor-pointer group shadow-lg"
                >
                  {/* Image */}
                  <img
                    src={image.image}
