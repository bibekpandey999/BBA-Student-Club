          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/80">
                <li>
                  <button onClick={() => router.push('/#home')} className="hover:text-white transition-colors">
                    Home
                  </button>
                </li>
                <li>
                ...
                <li>
                  <button onClick={() => router.push('/#events')} className="hover:text-white transition-colors">
                    Events
                  </button>
                </li>
              </ul>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" target="_blank" className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center hover:bg-white hover:text-primary transition-all">
                  <Twitter size={18} />
                </a>
              </div>
            </div>
